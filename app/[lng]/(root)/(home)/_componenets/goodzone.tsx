...
const Goodzone = () => {
	return (
		<div
			id='goodzone'
			className='container mx-auto max-w-6xl md:py-10 my-5 md:my-10 min-h-[130vh] md:max-md:pt-0 hero-module'
		>
			<div className='md:flex md:justify-between items-center  gap-8 max-md:grid-cols-1'>
				<div className='md:hidden'>
					<Image
						src={'/assets/portfolio/good.png'}
						alt='hero'
						width={252}
						height={49}
						className='object-cover max-w-[100%]'
					/>
					<div className='car eco w-[155px] my-4 '>
						<Image
							src={'/assets/portfolio/basket.svg'}
							alt='hero'
							width={25}
							height={25}
				...
				<div className='max-w-[530px] py-1'>
					<Image
						src={'/assets/portfolio/goodzonelap.png'}
						alt='hero'
						width={530}
						height={500}
				...
				<div className='max-w-[550px]'>
					<div className='hidden md:block'>
						<Image
							...
							className='object-cover max-w-[100%]'
						/>
						<div className='car eco w-[155px] my-8 '>
							<Image
								src={'/assets/portfolio/basket.svg'}
								alt='hero'
								width={25}
